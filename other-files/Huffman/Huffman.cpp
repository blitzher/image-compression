...
char *unique_array(char *string){
    ...
    /*Ensure that we check all elements in the array*/
    for (i = 0; i < n; i++){
        /*Checks all elements before i*/
        for (j = 0; j < i; j++){
        ...
        /*checks if they are the same, if they are unique will be incremented*/
        if (i == j){
    ...
    /*Return unique amount of characters*/
